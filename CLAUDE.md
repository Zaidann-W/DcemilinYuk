...
- Name : [DcemilinYuk]
- Description : [this project is about creating a website for small traders to sell their products]
- Goal : [The goal is to make it easier for small traders to sell their products and for customers to find the products they need]
- Target Users: [Small traders and customers who need products from small traders]
- Version : [v1.0.0]
...
[root]/
  src/
    ...
    [js]/    # [js file]
    [img]/    # [img file]
  public/          # Static assets that can be accessed by the public
